...
<html>
    <head>
        <title>Ccaizhdi Punctuation</title>
    ...
    <body>
        <h1>Introduction to Ccaizhdi Punctuation</h1>
        ...
        Links:
            ...
            <table>
                <tr>
                    <th>Keyboard &emsp;</th>
                    <th>Symbol function &emsp;</th>
                    <th>Symbol &emsp;</th>
                </tr>
                <tr>
                    <td>!</td>
                    <td>raised / strengthened voice or exclamations</td>
                    <td class='ccaizhdi'>!</td>
                </tr>
                <tr>
                    <td>?</td>
                    <td>lowered / saddened voice or questions</td>
                    <td class='ccaizhdi'>?</td>
                </tr>
                <tr>
                    <td>< ></td>
                    <td>Start and end quotes</td>
                    <td class='ccaizhdi'>< ></td>
                </tr>
                <tr>
                    <td>.</td>
            ...
            <ul>
                ...
                <li>The shrine, which is on that hill, is large.</li>
                <li>I would, if I could.</li>
                <li>I want do, but I cannot.</li>
                <li></li>
            </ul>

            The Ccaizhdi ., is at a board level similar to a semicolon. When needed, it can also act like a colon or a dash. However, it may never offset relative clauses--only the Ccaizhdi comma can do that.<br>
            For example:
            <ul>
                <li>I see a duck., the duck sees me.</li>
